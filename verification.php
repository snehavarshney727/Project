...
<nav class="navbar navbar-expand-lg navbar-light navbar-laravel">
    <div class="container">
        <a class="navbar-brand" href="#">Verification process</a>
                    ...
                    <div class="card-body">
                        <form action="#" method="POST">
                            ...
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a href="student.php"><button type="button" class="btn">BACK</button></a><br>
                            </div>
                    </div>
                    </form>
                </div>
    ...
    if(isset($_POST["verify"])){
        ...
        if($otp != $otp_code){
           ...
           <?php
            ...
            ?>
             <script>
                 alert("Verfication done, you may find your confirmation  by entering Student ID");
